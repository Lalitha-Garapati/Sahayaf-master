...
public class ClothesDetails extends AppCompatActivity
    ...
    String address = "", gender = "", user_mobile_no = "", imageName = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        age_group = (Spinner) findViewById(R.id.spinner);
    ...
    public void onBackPressed() {
        ...
        super.onBackPressed();
        startActivity(new Intent(ClothesDetails.this, CategorySelection.class));
        finish();
    }
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(ClothesDetails.this, R.string.failed, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public  void AddData() {
        ...
        if(male.isChecked())
            gender = String.valueOf(R.string.Male);
        else
            gender = String.valueOf(R.string.Female);
        ...
        if(itemName.getText().toString().equals("")||address.equals("")||user_mobile_no.equals("")||imageName.equals("")) {
            ...
            dbHelper.insert_clothes(itemName.getText().toString(), gender, age_group.getSelectedItem().toString(),
                address, user_mobile_no, imageName);
            Toast.makeText(ClothesDetails.this,R.string.post, Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(ClothesDetails.this, Clothes.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_food:
                intent = new Intent(ClothesDetails.this, Food.class);
                startActivity(intent);
                break;
            case R.id.nav_clothes:
                intent = new Intent(ClothesDetails.this, Clothes.class);
                startActivity(intent);
                break;
            case R.id.nav_books:
                intent = new Intent(ClothesDetails.this, Books.class);
                startActivity(intent);
                break;
            case R.id.nav_home_app:
                intent = new Intent(ClothesDetails.this, HomeAppliances.class);
                startActivity(intent);
                break;
            case R.id.nav_others:
                intent = new Intent(ClothesDetails.this, Others.class);
                startActivity(intent);
                break;
            case R.id.nav_post:
                intent = new Intent(ClothesDetails.this, CategorySelection.class);
                startActivity(intent);
                break;
            case R.id.nav_my_posts:
                intent = new Intent(ClothesDetails.this, MyPosts.class);
                startActivity(intent);
                break;
            case R.id.nav_profile:
                intent = new Intent(ClothesDetails.this, Profile.class);
                startActivity(intent);
                break;
        }
            ...
            Thread th = new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        handler.post(new Runnable() {
                            public void run() {
                                Toast.makeText(ClothesDetails.this, "Image size is too large", Toast.LENGTH_SHORT).show();
                                progressDialog.cancel();
                            }
                        });
                    }
