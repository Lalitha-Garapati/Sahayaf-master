...
public class HomeappPostDetails extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        data = dbHelper.fetch_particular_home_app(intent2.getStringExtra("ID"));
            ...
            Thread th = new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        handler.post(new Runnable() {
                            public void run() {
                                Toast.makeText(HomeappPostDetails.this, exceptionMessage, Toast.LENGTH_SHORT).show();
                            }
                        });
                    }
                }});
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(HomeappPostDetails.this, HomeAppliances.class));
        finish();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_food:
                intent = new Intent(HomeappPostDetails.this, Food.class);
                startActivity(intent);
                break;
            case R.id.nav_clothes:
                intent = new Intent(HomeappPostDetails.this, Clothes.class);
                startActivity(intent);
                break;
            case R.id.nav_books:
                intent = new Intent(HomeappPostDetails.this, Books.class);
                startActivity(intent);
                break;
            case R.id.nav_home_app:
                intent = new Intent(HomeappPostDetails.this, HomeAppliances.class);
                startActivity(intent);
                break;
            case R.id.nav_others:
                intent = new Intent(HomeappPostDetails.this, Others.class);
                startActivity(intent);
                break;
            case R.id.nav_post:
                intent = new Intent(HomeappPostDetails.this, CategorySelection.class);
                startActivity(intent);
                break;
            case R.id.nav_my_posts:
                intent = new Intent(HomeappPostDetails.this, MyPosts.class);
                startActivity(intent);
                break;
            case R.id.nav_profile:
                intent = new Intent(HomeappPostDetails.this, Profile.class);
                startActivity(intent);
                break;
        }
