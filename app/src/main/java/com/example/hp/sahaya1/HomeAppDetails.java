...
public class HomeAppDetails extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_home_app_details);
        ...
        if (requestCode == GALLERY) {
            if (data != null) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    Toast.makeText(HomeAppDetails.this, R.string.failed, Toast.LENGTH_SHORT).show();
                }
            }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(HomeAppDetails.this, CategorySelection.class));
        finish();
    }
    ...
    public  void AddData() {
        ...
        if(itemName.getText().toString().equals("")||address.equals("")||user_mobile_no.equals("")||imageName.equals("")) {
            ...
            dbHelper.insert_home_app(itemName.getText().toString(), address, user_mobile_no, imageName);
            Toast.makeText(HomeAppDetails.this,R.string.post, Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(HomeAppDetails.this, HomeAppliances.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            case R.id.nav_food:
                intent = new Intent(HomeAppDetails.this, Food.class);
                startActivity(intent);
                break;
            case R.id.nav_clothes:
                intent = new Intent(HomeAppDetails.this, Clothes.class);
                startActivity(intent);
                break;
            case R.id.nav_books:
                intent = new Intent(HomeAppDetails.this, Books.class);
                startActivity(intent);
                break;
            case R.id.nav_home_app:
                intent = new Intent(HomeAppDetails.this, HomeAppliances.class);
                startActivity(intent);
                break;
            case R.id.nav_others:
                intent = new Intent(HomeAppDetails.this, Others.class);
                startActivity(intent);
                break;
            case R.id.nav_post:
                intent = new Intent(HomeAppDetails.this, CategorySelection.class);
                startActivity(intent);
                break;
            case R.id.nav_my_posts:
                intent = new Intent(HomeAppDetails.this, MyPosts.class);
                startActivity(intent);
                break;
            case R.id.nav_profile:
                intent = new Intent(HomeAppDetails.this, Profile.class);
                startActivity(intent);
                break;
        }
        DrawerLayout drawer = (DrawerLayout) findViewById(R.id.drawer_layout);
            ...
            Thread th = new Thread(new Runnable() {
                public void run() {
                    try {
                        ...
                        handler.post(new Runnable() {
                            public void run() {
                                Toast.makeText(HomeAppDetails.this, "Image size is too large to upload", Toast.LENGTH_SHORT).show();
                                progressDialog.cancel();
                            }
                        });
                    }
